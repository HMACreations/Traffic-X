...
while true; do
    ...
    case $CHOICE in
        ...
        2)
            ...
            bash <(curl -s https://raw.githubusercontent.com/HMACreations/Traffic-X/main/rm-TX.sh)
...
if [ "$VERSION" == "latest" ]; then
    DOWNLOAD_URL="https://github.com/HMACreations/Traffic-X/archive/refs/heads/main.zip"
else
    DOWNLOAD_URL="https://github.com/HMACreations/Traffic-X/archive/refs/tags/$VERSION.zip"
fi
